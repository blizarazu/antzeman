...
/**
 * Testu bat eta web orri baten arteko konparaketa egiteko barne panela
 * 
 * @author Blizarazu
 * 
 */
public class TestuWebComposite extends Composite implements BarnePanela {
	 ...
	 * @param owner
	 */
	public TestuWebComposite(Composite parent, int style, MainGUI owner) {
		super(parent, style);
		...
		Group testuBatWebGroup;
		testuBatWebGroup = new Group(this, SWT.NONE);
		testuBatWebGroup.setText(Messages.testuWebKonparatu);
		group_2 = new Group(testuBatWebGroup, SWT.NONE);
		...
		sashForm = new SashForm(testuBatWebGroup, SWT.NONE);
		...
		button.addSelectionListener(fitxAukera);
		button.setText("...");
		...
		konparatzekoTestuaGroup.setText(Messages.konparatzekoWebOrria);
		group_1 = new Group(konparatzekoTestuaGroup, SWT.NONE);
		fitxategiaLabel_1 = new CLabel(group_1, SWT.NONE);
		fitxategiaLabel_1.setText(Messages.webHelbidea);
		fitxategiaLabel_1.pack();

		text_1 = new Text(group_1, SWT.BORDER);
		joanButton = new Button(group_1, SWT.NONE);
		joanButton.setData("testuZenb", "1");
		joanButton.addSelectionListener(new SelectionAdapter() {
			public void widgetSelected(final SelectionEvent e) {
				String url = text_1.getText();
				kargatuURL(url);
			}
		});
		joanButton.setText(Messages.joan);
		tabFolder = new CTabFolder(konparatzekoTestuaGroup, SWT.BORDER);

		final CTabItem webOrriaTabItem = new CTabItem(tabFolder, SWT.NONE);
		webOrriaTabItem.setText(Messages.webOrria);
		tabFolder.setSelection(webOrriaTabItem);

		final Composite composite_1 = new Composite(tabFolder, SWT.NONE);
		webOrriaTabItem.setControl(composite_1);

		browser = new Browser(composite_1, SWT.NONE);
		browser.addProgressListener(new OrriaKargatua());
		final GroupLayout groupLayout_7 = new GroupLayout(composite_1);
		groupLayout_7.setHorizontalGroup(groupLayout_7.createParallelGroup(
				GroupLayout.LEADING).add(browser, GroupLayout.PREFERRED_SIZE,
				212, Short.MAX_VALUE));
		groupLayout_7.setVerticalGroup(groupLayout_7.createParallelGroup(
				GroupLayout.LEADING).add(browser, GroupLayout.PREFERRED_SIZE,
				173, Short.MAX_VALUE));
		composite_1.setLayout(groupLayout_7);

		final CTabItem testuaTabItem = new CTabItem(tabFolder, SWT.NONE);
		testuaTabItem.setText(Messages.testua);

		final Composite composite = new Composite(tabFolder, SWT.NONE);
		testuaTabItem.setControl(composite);

		styledText_1 = new StyledText(composite, SWT.WRAP | SWT.V_SCROLL);
		styledText_1.setEditable(false);
		final GroupLayout groupLayout_6 = new GroupLayout(composite);
		groupLayout_6.setHorizontalGroup(groupLayout_6.createParallelGroup(
				GroupLayout.LEADING).add(styledText_1,
				GroupLayout.PREFERRED_SIZE, 96, Short.MAX_VALUE));
		groupLayout_6.setVerticalGroup(groupLayout_6.createParallelGroup(
				GroupLayout.LEADING).add(styledText_1,
				GroupLayout.PREFERRED_SIZE, 78, Short.MAX_VALUE));
		composite.setLayout(groupLayout_6);
		...
		groupLayout_1.setHorizontalGroup(groupLayout_1.createParallelGroup(
				...
				groupLayout_1.createSequentialGroup().addContainerGap().add(
						groupLayout_1.createParallelGroup(GroupLayout.TRAILING)
								.add(GroupLayout.LEADING, tabFolder,
		...
		groupLayout_1.setVerticalGroup(groupLayout_1.createParallelGroup(
				...
				groupLayout_1.createSequentialGroup().add(group_1,
						GroupLayout.PREFERRED_SIZE, 46,
						GroupLayout.PREFERRED_SIZE).addPreferredGap(
						LayoutStyle.RELATED).add(tabFolder,
		...
		groupLayout_3.setHorizontalGroup(groupLayout_3.createParallelGroup(
				...
				groupLayout_3.createSequentialGroup().addContainerGap().add(
						...
						GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
						.addPreferredGap(LayoutStyle.RELATED).add(text_1,
								GroupLayout.PREFERRED_SIZE, 102,
								Short.MAX_VALUE).addPreferredGap(
								LayoutStyle.RELATED).add(joanButton)
						.addContainerGap()));
		...
		analisiZehatzaButton = new Button(testuBatWebGroup, SWT.NONE);
		...
		analisiAzkarraButton = new Button(testuBatWebGroup, SWT.NONE);
		...
		groupLayout_4.setHorizontalGroup(groupLayout_4.createParallelGroup(
				...
				groupLayout_4.createSequentialGroup().addContainerGap().add(
						testuBatWebGroup, GroupLayout.PREFERRED_SIZE, 569,
						Short.MAX_VALUE).addContainerGap()));
		groupLayout_4.setVerticalGroup(groupLayout_4.createParallelGroup(
				GroupLayout.LEADING).add(
				groupLayout_4.createSequentialGroup().addContainerGap().add(
						testuBatWebGroup, GroupLayout.PREFERRED_SIZE, 420,
						Short.MAX_VALUE).addContainerGap()));
		final GroupLayout groupLayout_8 = new GroupLayout(testuBatWebGroup);
		groupLayout_8.setHorizontalGroup(groupLayout_8.createParallelGroup(
				...
				groupLayout_8.createSequentialGroup().addContainerGap().add(
						groupLayout_8.createParallelGroup(GroupLayout.LEADING)
								.add(GroupLayout.TRAILING, sashForm,
										GroupLayout.PREFERRED_SIZE, 545,
										Short.MAX_VALUE).add(
										GroupLayout.TRAILING,
										groupLayout_8.createSequentialGroup()
												.add(analisiZehatzaButton)
												.addPreferredGap(
														LayoutStyle.RELATED)
												.add(analisiAzkarraButton))
								.add(GroupLayout.TRAILING, group_2,
										GroupLayout.PREFERRED_SIZE, 545,
										Short.MAX_VALUE)).addContainerGap()));
		groupLayout_8.setVerticalGroup(groupLayout_8.createParallelGroup(
				...
				groupLayout_8.createSequentialGroup().addContainerGap().add(
						...
						GroupLayout.PREFERRED_SIZE, 346, Short.MAX_VALUE)
						.addPreferredGap(LayoutStyle.RELATED).add(
								groupLayout_8.createParallelGroup(
										GroupLayout.BASELINE).add(
										analisiZehatzaButton).add(
										analisiAzkarraButton))
						.addContainerGap()));
		testuBatWebGroup.setLayout(groupLayout_8);
		setLayout(groupLayout_4);

		getShell().setDefaultButton(joanButton);
	}
	...
	/**
	 * Web orria kargatzeko botoiaren ekintza
	 * 
	 * @author Blizarazu
	 * 
	 */
	private final class OrriaKargatua extends ProgressAdapter {
		/*
		 * (non-Javadoc)
		 * 
		 * @see org.eclipse.swt.browser.ProgressAdapter#completed(org.eclipse.swt.browser.ProgressEvent)
		 */
		public void completed(final ProgressEvent event) {
			String url = ((Browser) event.getSource()).getUrl();
			if (url.indexOf("about:blank") == -1) {
				text_1.setText(url);
				jabea.kargatuWebOrria(url);
				styledText_1.setText(kud.getTestua(1).getTestua());
	...
	private final class AnalisiAzkarra extends SelectionAdapter {
		...
		public void widgetSelected(final SelectionEvent e) {
			try {
				...
				emaitzaLabel.setText(Messages.biTestuAntzeko1 + emaitza
		...
		try {
			if (fitx != null) {
				...
				case 0:
					...
					break;
				case 1:
					if (kud.getTestua(testuZenb).getMota() == Testua.WEB_ORRIA) {
	 ...
	 */
	public void kargatuURL(String url) {
		if (url.length() > 0) {
			browser.setUrl(url);
			analisiAzkarraButton.setEnabled(false);
			analisiZehatzaButton.setEnabled(false);
